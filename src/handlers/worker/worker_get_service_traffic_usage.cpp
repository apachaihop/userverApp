...
#include "worker_get_service_traffic_usage.hpp"
#include "../../DTO/trafic_usage.hpp"
#include "../../DTO/worker_traffic.hpp"
#include "../../db/sql.hpp"
...
userverApp::handlers::worker::worker_get_service_traffic_usage::
    worker_get_service_traffic_usage(
...
formats::json::Value worker_get_service_traffic_usage::HandleRequestJsonThrow(
  ...
  auto worker_res = pg_cluster_->Execute(
      ...
      userverApp::sql::kSelectWorkerByTrafficUsageForEachService.data(), id);
  auto response =
      worker_res.AsContainer<std::vector<userverApp::entity::worker_traffic>>();
